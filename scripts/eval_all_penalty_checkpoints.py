"""Launch evaluations on all penalty RL checkpoints.
...
Usage:
    uv run scripts/eval_all_penalty_checkpoints.py --max-concurrent 20
    uv run scripts/eval_all_penalty_checkpoints.py --max-concurrent 20 --dry-run
"""
    ...
    for run_name in PENALTY_RUNS:
        ...
        with open(ckpt_file) as f:
            for line in f:
                ...
                out_file = eval_dir / f"{model_slug}_{name}.jsonl"
...
def main():
    ...
    parser.add_argument("--output-base", default="logs/eval-penalty")

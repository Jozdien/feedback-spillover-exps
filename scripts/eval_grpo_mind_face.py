...
def main():
    ...
    import nest_asyncio
    nest_asyncio.apply()
    asyncio.run(evaluate(args.model, args.mind_checkpoint, args.face_checkpoint, args.max_questions, args.batch_size, args.output_dir, args.max_cot_tokens, args.question_seed))
